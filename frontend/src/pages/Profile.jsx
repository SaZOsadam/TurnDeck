...
import {
  getProfile,
  getPlatformAccounts, PLATFORM_META,
  getActivePlaylists, getArchivedPlaylists, getStats, getTopSongs,
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-5">
      ...
      {activeSection === 'overview' && (
        <div className="space-y-4">
          ...
          <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
            ...
            <Link to="/stats" className="block text-center text-green-400 text-xs mt-3 hover:text-green-300 transition-colors">See full stats</Link>
          </div>
      ...
      {activeSection === 'account' && (
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-5 space-y-4">
          <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-wide">Cloud Account</h2>
          {!user ? (
